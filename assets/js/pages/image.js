...
document.getElementById("publishBtn").onclick = async ()=>{
  ...
  if(!mainLink) return alert("Image url required");
  setStatus("Publishing Image...", "warn");
  const html=buildPostHtml({type:"IMAGE", title, label:activeLabel, desc, mainLink, extraLink:"", bodyText:""});
  await publishPost({title, html, labels:[activeLabel,"IMAGE"]});
