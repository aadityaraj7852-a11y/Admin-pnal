...
document.getElementById("publishBtn").onclick = async ()=>{
  ...
  if(!mainLink) return alert("PDF link required");
  setStatus("Publishing PDF...", "warn");
  const html=buildPostHtml({type:"PDF", title, label:activeLabel, desc, mainLink, extraLink:"", bodyText:""});
  await publishPost({title, html, labels:[activeLabel,"PDF"]});
